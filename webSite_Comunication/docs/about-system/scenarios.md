...
<div class="persona">
    <img src={PersonaMatilde} class="persona_img" />
...
<div class="persona">
    <img src={PersonaTiago} class="persona_img" />
    <div class="persona_info">
...
<div class="persona">
    <img src={PersonaBernardo} class="persona_img" />
    <div class="persona_info">
...
<div class="persona">
    <img src={PersonaManuela} class="persona_img" />
    <div class="persona_info">
        **Dr. Manuela Santos** is a scout doctor that has 32 years old and is a volunteer medical staff at the scouts event.
        ...
        > **_Motivation:_** She expects the event to be as organized as possible as well as equipped with all the material that is need to provide adequate medical support during the event.
    </div>
</div>
...
<div class="persona">
    <img src={PersonaAfonso} class="persona_img" />
    <div class="persona_info">
        **Afonso Fernandes** is a college student that has 22 years old and is a scout and a volunteer sales staff at the event merchandise booth. Afonso wants to promote and sell scout merchandise to raise funds for troop activities and projects.
        ...
        > **_Motivation:_** Afonso look forwards to a system that can help him check the remaining stock and streamline sales transactions so it can have everything organized and in order. The stock should be always updated so he can know if he can sale a certain product.
    </div>
</div>
...
<div class="persona">
    <img src={PersonaAntonio} class="persona_img" />
    <div class="persona_info">
        **António Amaral** is security gard with 45 years old that is a volunteer entrance staff at the event registration entrance. His function is to ensure smooth check-in process for scouts and volunteers, provide event information, and assist with any inquiries.
        ...
        > **_Motivation:_** António needs something something to make his job easier. He expect that the event registrations and access control should be improved, avoiding access control with tickets and slow verifications.
    </div>
</div>
...
<div class="persona">
    <img src={PersonaJose} class="persona_img" />
    <div class="persona_info">
        **José Esteves** is an IT Manager that has over than 50 years. He is one of the event administrators overseeing the FlexiGather system for the scouts event. His main goal is to ensure the FlexiGather system functions smoothly for event registrations, scheduling, and communication. To achieve his main goal there are some pain points like addressing technical issues with the FlexiGather platform, managing user accounts and permissions, coordinating with other event staff for system integration.
        ...
        > **_Motivation:_** In order to keep everything registered and stored according to the law, the administrator is looking for a way to manage all the logistics of events, registrations, communication and medical emergencies in an intuitive and coordinated way.
    </div>
</div>
...
Afonso wants to load money to the account of one of the scouts, as he is part of the sales team and is at a loading point.
